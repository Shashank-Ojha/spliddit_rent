(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        global.ReactBootstrapSliderFixedFixed = mod.exports;
    }
    ...
    exports.ReactBootstrapSliderFixed = undefined;
    ...
    var ReactBootstrapSliderFixed = exports.ReactBootstrapSliderFixed = function (_React$Component) {
        _inherits(ReactBootstrapSliderFixed, _React$Component);

        function ReactBootstrapSliderFixed(props) {
            _classCallCheck(this, ReactBootstrapSliderFixed);

            var _this = _possibleConstructorReturn(this, (ReactBootstrapSliderFixed.__proto__ || Object.getPrototypeOf(ReactBootstrapSliderFixed)).call(this, props));

            _this.updateSliderValues = _this.updateSliderValues.bind(_this);
            return _this;
        }

        _createClass(ReactBootstrapSliderFixed, [{
            ...
            value: function updateSliderValues() {
                ...
                if (this.props.rangeHighlights && (this.mySlider.rangeHighlights || this.mySlider.options.rangeHighlights)) {
                    this.mySlider.setAttribute("rangeHighlights", this.props.rangeHighlights);
                }
        ...
        return ReactBootstrapSliderFixed;
    }(_react2.default.Component);

    ReactBootstrapSliderFixed.propTypes = {
    ...
    exports.default = ReactBootstrapSliderFixed;
});
